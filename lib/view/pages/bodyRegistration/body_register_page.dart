        ...
        children: <Widget>[
          ...
          Row(
            ...
            children: [
              CustomComponents(
                registerDays:
                    heightRegisterDays == null ? "" : "$heightRegisterDays",
                text: "身長",
                params: fitnessHeight == null ? "150cm" : '$fitnessHeight cm',
                width: 150,
                height: 150,
                ontap: Height(),
                icon: Icon(
              ...
              CustomComponents(
                registerDays:
                    weightRegisterDays == null ? "" : "$weightRegisterDays",
                text: "体重",
                params: fitnessWeight == null
                    ? "Today : 50kg"
                    : "Today : $fitnessWeight",
                width: 150,
                height: 150,
